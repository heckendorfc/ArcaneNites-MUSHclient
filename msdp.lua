...
function OnPluginTelnetRequest (type, data)
	...
	elseif type == MSDP and data == "SENT_DO" then
		...
		SendPkt ("\255\250\69\1REPORT\2MINI_MAP\2AFFECTS\2HEALTH\2HEALTH_MAX\2MANA\2MANA_MAX\2MOVEMENT\2MOVEMENT_MAX\2HITROLL\2DAMROLL\2SAVES\2AC\2STR\2INT\2WIS\2CON\2DEX\2CHA\255\240")
		return true
